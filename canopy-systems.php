...
<head>
    ...
    <title>T&J Waterfront Services LLC  &#8211;  Canopy Systems</title>
   
    <meta name='robots' content='noindex,nofollow'>
    <link rel='dns-prefetch' href='//fonts.googleapis.com'>
    

    <meta property="og:title" content="T&J Waterfront Services LLC  &#8211;  Canopy Systems">
...
<li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-200">
                    ...
                    <div class="search_wrap search_style_normal search_mobile">
                        <div class="search_form_wrap">
                            <form role="search" method="get" class="search_form" action="https://www.facebook.com/Tjwaterfrontservices">
                                <input type="hidden" value="" name="post_types">
                                <input type="text" class="search_field" placeholder="Search" value="" name="s">
                                                            ...
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-f00561e sc_fly_static elementor-widget elementor-widget-shortcode" data-id="f00561e" data-element_type="widget" data-widget_type="shortcode.default">
                                                                        <div class="elementor-widget-container">
                                                                            	<div class="sc_promo_image" style="background-image:url(https://tjwaterfrontservices.b-cdn.net/img/17361845_1543134785706329_6536865908055089921_n.jpg);width:100%;left: 0; height:700px; padding: 15% 15% 0 5%;">
                                                                            ...
                                                                            <div id="trx_sc_promo_1082858345" class="sc_promo sc_promo_default sc_promo_size_large sc_promo_image_position_left">
																				...
																				<div class="sc_promo_text" style="width: 50%;float: left;   background-image: url(https://tjwaterfrontservices.b-cdn.net/img/bg-4.jpg); background-position: top left; background-repeat: no-repeat; background-size: cover;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 23.7%; background:none;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text" style="color:white">Starr Pro<br> Canopy Systems</span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr scheme_dark">
                                                                                            <br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/image1cs.png" style="width:100%; height:auto;">
																							<br/>
																							<br/>
																							<p>
																								<ul>
																									<li class="scheme_dark">Starr Pro Canopy Systems now offer even more coverage for your investment, as well as different boarding options. </li>
																									<li class="scheme_dark">12” drop side gives 50” of coverage from peak  to bottom of Balance </li>
																									<li class="scheme_dark">24” drop side, maximum coverage of 60”  from peak of canopy to bottom of valance.   This canopy offers the most  coverage in the industry. </li>
																									
																									<li class="scheme_dark">Front boarding access </li>
																									
																									<li class="scheme_dark">Rear boarding access </li>
																									<li class="scheme_dark">Side boarding access  </li>
																									<li class="scheme_dark">These canopy options  allow you to leave bimini  in travel position,  or leave arch up </li>		
																								</ul>
                                                                                        ...
                                                                                        <div id="sc_button_2123267877" class="sc_item_button sc_button_wrap sc_item_button sc_item_button_default sc_promo_button"><a href="StarrDocks 2020_12.17.pdf#page=17" target="_blank" class="sc_button sc_button_default sc_button_size_normal sc_button_icon_left"><span class="sc_button_text"><span class="sc_button_title">For more information</span></span><!-- /.sc_button_text --></a>
                                                                                            <!-- /.sc_button -->
                                                                                        </div>
                                                                                        <!-- /.sc_item_button -->
                                                                                    </div>
																				 ...
																				 <div class="sc_promo_text" style="width: 50%;float: right;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 15%;">
                                                                                        ...
                                                                                        <div class="sc_item_descr sc_promo_descr">
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/68781720_2710663385620124_4415849399654023168_n.jpg" style="width:100%; height:auto;">
																							<br/>
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/image3cs.png" style="width:100%; height:auto;">
																							<br/>
																							<br/>
