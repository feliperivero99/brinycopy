                                                            ...
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-f00561e sc_fly_static elementor-widget elementor-widget-shortcode" data-id="f00561e" data-element_type="widget" data-widget_type="shortcode.default">
                                                                        <div class="elementor-widget-container">
                                                                            	<div class="sc_promo_image" style="background-image:url(https://tjwaterfrontservices.b-cdn.net/img/scenic-view-of-the-majestic-mountains-by-the-docks-in-the-3030833.jpg);width:100%;left: 0; height:700px;  padding: 15% 15% 0 5%;">
                                            ...
                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                <div class="elementor-widget-wrap">
                                                    <div class="sc_layouts_item elementor-element elementor-element-2eb7ac0 sc_fly_static elementor-widget elementor-widget-text-editor" data-id="2eb7ac0" data-element_type="widget" data-widget_type="text-editor.default">
                                                        <div class="elementor-widget-container">
                                                            <div class="elementor-text-editor elementor-clearfix">
                                                               <p><a style="font-size: 14px; text-transform: uppercase; font-weight: 800;" href="https://www.facebook.com/Tjwaterfrontservices/" target="_blank" rel="noopener">T&J Waterfront Services LLC</a> <span style="font-size: 14px; font-style: normal; font-weight: 800; text-transform: uppercase;"></span><span style="font-size: 14px; text-transform: uppercase; font-weight: 800;">&copy; &copy; 2016-<?php echo date("Y"); ?>  - Powered By <a href="https://schrader.co" target="blank">Schrader Web Solutions<a/></span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
