...
<head>
    ...
    <title>T&J Waterfront Services LLC  &#8211; Cantilever & Vertical Jet Ski Lifts</title>
   
    <meta name='robots' content='noindex,nofollow'>
    <link rel='dns-prefetch' href='//fonts.googleapis.com'>
    

    <meta property="og:title" content="T&J Waterfront Services LLC  &#8211; Cantilever & Vertical Jet Ski Lifts">
                                                            ...
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-f00561e sc_fly_static elementor-widget elementor-widget-shortcode" data-id="f00561e" data-element_type="widget" data-widget_type="shortcode.default">
                                                                        <div class="elementor-widget-container">
                                                                            	<div class="sc_promo_image" style="background-image:url(https://tjwaterfrontservices.b-cdn.net/img/people-riding-a-jet-ski-1430675.jpg);width:100%;left: 0; height:700px; padding: 15% 15% 0 5%;">
                                                                            ...
                                                                            <div id="trx_sc_promo_1082858345" class="sc_promo sc_promo_default sc_promo_size_large sc_promo_image_position_left">
																				...
																				<div class="sc_promo_text" style="width: 50%;float: left;   background-image: url(https://tjwaterfrontservices.b-cdn.net/img/bg-4.jpg); background-position: top left; background-repeat: no-repeat; background-size: cover;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 23.7%; background:none;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text" style="color:white">Vertical Single Jet Ski <br> and Small Boat Lift</span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr scheme_dark">
                                                                                            <br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/img29.JPG" style="width:50%; height:auto;">
																							<br/>
																							<br/>
																							<p class="scheme_dark">
																							JL1563 and JL1575 provide two great options for small boats and jet skis. This 1,500lb capacity aluminum light weight lift not only has more bed travel but is also available in 63 inch and 75 inch widths to accommodate larger jet skis and small boats. Poly wrapped full length bunks protect the hull of your watercraft.  Our legs offer infinite adjustment to conform to different lake bottoms.  As on all of our lifts, this one has a heavy duty winch with a 30” oversized aluminum powder coated wheel that allows for easier cranking.  All of our lift cables are stainless steel to resist rust and corrosion.

																							</p>
																							<p class="scheme_dark"><b>OPTIONAL UPGRADES:</b></p>
																							
																							<p>
																								<ul>
																									<li class="scheme_dark"> 12V AC or DC power with solar panel</li>
																									<li class="scheme_dark">Guide INS are available to protect your investment from unnecessary scratches or hull damage </li>
																									<li class="scheme_dark">Canopy System – will offer protection for your watercraft or small boat from weather elements. Vertical lifts offer the ability to  tuck your watercraft almost completely  under the material keeping seats and  electronics dry.</li>
																				 ...
																				 <div class="sc_promo_text" style="width: 50%;float: right;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 23.7%;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text">Starr Vertical Double<br> Jet Lift </span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr">
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/img30.JPG" style="width:45%; height:auto;">
																							<br/>
																							<br/>
																							<p>
																							JLV3500 is the ultimate of all double jet ski lifts on the market.  It holds two PWC’s at adjustable, staggered heights that give you the option to take one PWC out at a time and not have the other float away. Lift comes standard with a 42” manual powder coated aluminum wheel.
																							</p>
																							<p>
																							<b>OPTIONAL UPGRADES:</b> 
																							
																							</p>
																							<p>
																							
																								<ul>
																									<li class="">12V AC or DC power with solar panel. </li>
																									<li class="">Guide ins are available to protect your investment  from unnecessary scratches or hull damage </li>
																									<li class=""> Canopy System – will cover your personal watercrafts  and protect them from the elements. With a vertical  lift you are able to tuck your PWC’s up under the  canopy material to keep the seats, electronics and  foot pads from weather damage.  It also saves you  time from having to remove the covers when you  want to have fun in the sun! </li>
                                                                            ...
                                                                            <div id="trx_sc_promo_1082858345" class="sc_promo sc_promo_default sc_promo_size_large sc_promo_image_position_left">
                                                                                <!-- /.sc_promo_image -->
																				 ...
																				 <div class="sc_promo_text" style="width: 100%;float: left;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 23.7%;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text">Starr Cantilever<br> Jet Ski Lifts</span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr">
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/img31.JPG" style="width:50%; height:auto;">
																							<br/>
                                                                                           
																							<p>
																							
																								<ul>
																									<li class="">1,500lb capacity 64” wide </li>
																									<li class="">Heavy duty  winch with  pulley bar design </li>
																									<li class="">30” aluminum  powder coated  wheel</li>
																						...
																						<div id="sc_button_2123267877" class="sc_item_button sc_button_wrap sc_item_button sc_item_button_default sc_promo_button"><a href="StarrDocks 2020_12.17.pdf#page=14" target="_blank" class="sc_button sc_button_default sc_button_size_normal sc_button_icon_left"><span class="sc_button_text"><span class="sc_button_title">For more information</span></span><!-- /.sc_button_text --></a>
                                                                                            <!-- /.sc_button -->
                                                                                        </div>
