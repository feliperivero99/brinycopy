...
jQuery( document ).ready(
	function() {
		...
		function briny_resize_video(cont) {
			...
			cont.find( '.video_frame iframe' ).each(
				function() {
					// If item now invisible
					if (jQuery( this ).hasClass( 'trx_addons_resize' ) || jQuery( this ).addClass( 'briny_resize' ).parents( 'div:hidden,section:hidden,article:hidden' ).length > 0) {
						return;
					}
    ...
    var elementorFrontendConfig = {
            ...
            "version": "2.8.2",
            "urls": {
                "assets": "http:\/\/briny.ancorathemes.com\/wp-content\/plugins\/elementor\/assets\/"
            },
            "settings": {
                "page": [],
                "general": {
