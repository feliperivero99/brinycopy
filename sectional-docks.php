                                                            ...
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-f00561e sc_fly_static elementor-widget elementor-widget-shortcode" data-id="f00561e" data-element_type="widget" data-widget_type="shortcode.default">
                                                                        <div class="elementor-widget-container">
                                                                            	<div class="sc_promo_image" style="background-image:url(https://tjwaterfrontservices.b-cdn.net/img/38396D0A-27C0-4F9C-9227-944FCECBE0AE.jpeg);width:100%;left: 0; height:700px; padding: 15% 15% 0 5%;">
                                                                            ...
                                                                            <div id="trx_sc_promo_1082858345" class="sc_promo sc_promo_default sc_promo_size_large sc_promo_image_position_left">
																				...
																				<div class="sc_promo_text" style="width: 50%;float: left;   background-image: url(https://tjwaterfrontservices.b-cdn.net/img/bg-4.jpg); background-position: top left; background-repeat: no-repeat; background-size: cover;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 15%; background:none;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text" style="color:white">PREMIUM<br> ANODIZED</span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr scheme_dark">
                                                                                            <br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/14650234_1382428275110315_8749198068660707137_n.jpg" style="width:100%; height:auto;">
																							<br/>
																							<br/>
																							<p class="scheme_dark">
																							Known as “KOOL DOCK”! Our Best Seller! With its’ strength and light weight, this is easily the industry leader for dock. We use anodized stringers and two center supports. Anodized aluminum stays cooler than vinyl and wood. It will not rust, turn black, or warp. Not only do you get a clean look, but it has a virtually maintenance free finish that you will be able to enjoy for years to come!
																							</p>
																							<p class="scheme_dark">Anodized aluminum:  Available in 3x10, 4x10, 5x10, 6x10, 4x8, 8x8</p>
																							<p class="scheme_dark"> We can also create custom and angle sections</p>
																							<br/>
																							<br/>
																							
																						</div>
                                                                                        <div id="sc_button_2123267877" class="sc_item_button sc_button_wrap sc_item_button sc_item_button_default sc_promo_button"><a href="StarrDocks 2020_12.17.pdf#page=3" target="_blank" class="sc_button sc_button_default sc_button_size_normal sc_button_icon_left"><span class="sc_button_text"><span class="sc_button_title">FOR MORE INFORMATION</span></span><!-- /.sc_button_text --></a>
                                                                                            <!-- /.sc_button -->
                                                                                        </div>
                                                                                        <!-- /.sc_item_button -->
                                                                                    </div>
																				 ...
																				 <div class="sc_promo_text" style="width: 50%;float: right;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 15%;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text">POWDER COATED<br>ALUMINUM</span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr">
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/img3.JPG" style="width:100%; height:auto;">
																							<br/>
																							<br/>
                                                                                            <p>
																							Constructed with two center supports, and topped with a hard powder coat finish. Powder coated aluminum will stay cooler than vinyl and wood. It will not rust or turn black. With it’s virtually maintenance free finish it will last a lifetime! 
																							</p>
																							<p>
																							Powder Coated Aluminum:  Available in 3x10, 4x10, 5x10, 6x10, 4x8, 8x8.
																							</p>
																							<p>
																							We can also create custom and angle sections. 
																							</p>
																							<p>
																							Also available in Cedar Breeze and Sand Beige.
