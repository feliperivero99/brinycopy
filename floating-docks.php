...
<head>
    ...
    <title>T&J Waterfront Services LLC &#8211; Floating Docks</title>
   
    <meta name='robots' content='noindex,nofollow'>
    <link rel='dns-prefetch' href='//fonts.googleapis.com'>
    

    <meta property="og:title" content="T&J Waterfront Services LLC &#8211; Floating Docks">
                                                            ...
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-f00561e sc_fly_static elementor-widget elementor-widget-shortcode" data-id="f00561e" data-element_type="widget" data-widget_type="shortcode.default">
                                                                        <div class="elementor-widget-container">
                                                                            	<div class="sc_promo_image" style="background-image:url(https://tjwaterfrontservices.b-cdn.net/img/image1f.png);width:100%;left: 0; height:700px; padding: 15% 15% 0 5%;">
                                                                            ...
                                                                            <div id="trx_sc_promo_1082858345" class="sc_promo sc_promo_default sc_promo_size_large sc_promo_image_position_left">
																				...
																				<div class="sc_promo_text" style="width: 50%;float: left;   background-image: url(https://tjwaterfrontservices.b-cdn.net/img/bg-4.jpg); background-position: top left; background-repeat: no-repeat; background-size: cover;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 23.7%; background:none;">
                                                                                        <h2 class="sc_item_title sc_promo_title sc_item_title_style_decoration sc_item_title_tag"><span class="sc_item_title_text" style="color:white">How do you know if you need a Floating Dock? </span></h2>
                                                                                        <div class="sc_item_descr sc_promo_descr scheme_dark">
                                                                                            <br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/14516525_1363820420304434_6762330094175751173_n.jpg" style="width:100%; height:auto;">
																							<br/>
																							<br/>
																							<p class="scheme_dark">
																							 <b>Do you have water depths that are greater than 9 feet?</b>  
																							</p>
																							...
																							<p class="scheme_dark">
																							 <b>Do you have significant fluctuation in water depth? </b>  
																							</p>
																							...
																							<p class="scheme_dark">
																							 <b>Do you have a very mucky lake bottom?</b>  
																							</p>
																							...
																							<p class="scheme_dark">
																							 <b>Starr Floating Dock Benefits:</b>  
																							</p>
																							
																							<p class="scheme_dark">
																								 <ul>
																									<li class="scheme_dark">Adjusts to fluctuating water conditions</li>
																									<li class="scheme_dark">Modular design</li>
																									<li class="scheme_dark">Easy to install</li>
																									<li class="scheme_dark"> Many accessories to customize your dock</li>
																									<li class="scheme_dark">Add-on capability </li>
																									<li class="scheme_dark">Salt water safe </li>
																									<li class="scheme_dark">15-year warranty</li>
																									<li class="scheme_dark">floating dock is available in our Truss or Platinum style docks</li>
																								 
																								 </ul>
																							
																							</p>
																							<p class="scheme_dark">
																							STARR floating dock is available in the following sizes: 4x8, 4x12, 4x16. Sundecks available in 8x8, 8x12, and 8x16.

																							</p>
																							
																							<br/>
																						</div>
                                                                                        <div id="sc_button_2123267877" class="sc_item_button sc_button_wrap sc_item_button sc_item_button_default sc_promo_button"><a href="StarrDocks 2020_12.17.pdf#page=10" target="_blank" class="sc_button sc_button_default sc_button_size_normal sc_button_icon_left"><span class="sc_button_text"><span class="sc_button_title">For more information</span></span><!-- /.sc_button_text --></a>
                                                                                            <!-- /.sc_button -->
                                                                                        </div>
                                                                                        <!-- /.sc_item_button -->
                                                                                    </div>
																				 ...
																				 <div class="sc_promo_text" style="width: 50%;float: right;">
                                                                                    <div class="sc_promo_text_inner trx_addons_inline_874151218"  style="padding: 5% 5%;">
                                                                                        ...
                                                                                        <div class="sc_item_descr sc_promo_descr">
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/FB971D0D-1C2A-4E4F-89B1-851159C07731.jpeg" style="width:100%; height:auto;">
																							<br/>
																							
																							<br/>
																							<img src="https://tjwaterfrontservices.b-cdn.net/img/66669CBF-9322-48DC-A060-9AFC7DC292B6.jpeg" style="width:100%; height:auto;">
